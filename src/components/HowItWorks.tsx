  ...
  const steps = [
    {
      ...
      description: "Connectez votre environnement AWS en quelques clics. Accès read-only uniquement, vos données restent sécurisées.",
    ...
    },
    {
      ...
      description: "COMPLIO analyse en continu vos ressources AWS et vérifie leur conformité aux 114 contrôles ISO 27001.",
